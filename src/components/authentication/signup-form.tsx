            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <Input
                  ...
                  required
                />
                <FieldDescription className="text-[13px] text-center">
              ...
              <FieldDescription className="text-center">
                Already have an account? <span className="cursor-pointer hover:text-primary underline" onClick={() => navigate("/login")}>Sign in</span>
              </FieldDescription>
            </FieldGroup>
          </form>
