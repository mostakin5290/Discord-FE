    ...
    return (
        <Sheet>
            ...
            <SheetContent
                ...
                <Accordion type="single" collapsible className="hide-scrollbar mb-32 pl-0 w-full flex flex-1 flex-col justify-start items-stretch gap-x-2 bg-transparent overflow-auto">
