            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="flex items-center gap-6">
                            <a href="#" className="text-white hover:text-primary transition-transform hover:scale-110"><Twitter className="w-6 h-6" /></a>
                            <a href="#" className="text-white hover:text-primary transition-transform hover:scale-110"><Instagram className="w-6 h-6" /></a>
                            <a href="#" className="text-white hover:text-primary transition-transform hover:scale-110"><Facebook className="w-6 h-6" /></a>
                            <a href="#" className="text-white hover:text-primary transition-transform hover:scale-110"><Youtube className="w-6 h-6" /></a>
                            <a href="#" className="text-white hover:text-primary transition-transform hover:scale-110"><Github className="w-6 h-6" /></a>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors">App Directory</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Newsroom</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors">College</a></li>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <a href="#" className="flex items-center gap-2 group">
                        <span className="text-white font-[900] text-xl font-logo tracking-tight">Discord</span>
                    </a>
