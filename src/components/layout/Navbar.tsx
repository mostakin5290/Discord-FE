      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between">
                      ...
                      {[
                        ...
                        <li key={i}>
                          <NavigationMenuLink asChild>
                            <a
                              href="#"
                              className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-white/5 focus:bg-white/5 group"
                            >
          ...
          <div className="hidden md:flex items-center gap-4">
            <Button
              onClick={() => navigate(token ? afterSignInUrl : "/login")}
              size="sm"
          ...
          <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent
                side="right"
                className="bg-[#020617] border-l-white/10 text-white w-[300px]"
              >
                <div className="flex flex-col gap-6 mt-8">
                  <a
                    href="#"
                    className="text-lg font-bold hover:text-primary flex items-center gap-2 transition-colors"
                  >
                  ...
                  <Button
                    onClick={() => navigate(token ? afterSignInUrl : "/login")}
                    variant="secondary"
                    className="w-full bg-white/5 text-white hover:bg-white/10 rounded-full border border-white/5"
                  >
                    {token ? "Open Discord" : "Login"}
                  </Button>
                </div>
